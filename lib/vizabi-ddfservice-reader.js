...
/* harmony import */ var urlon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! urlon */ "./node_modules/urlon/src/urlon.js");
...
var getReader = function getReader(options) {
  return {
    ...
    parsers: {
      time: function time(timeString) {
        ...
        if (Number.isInteger(timeString)) {
          ...
          return timeString >= 0 && timeString < 10000 ? moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc({
            year: timeString,
            month: 0,
            day: 1
          }).toDate() : undefined;
          ...
          if (match) {
            ...
            if (match[4]) {
              return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString, 'YYYYMMDD').toDate();
            } else if (match[3]) {
              return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString, 'YYYYMM').toDate();
            } else if (match[2].length === 2) {
              return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString, 'YYYYqQ').toDate();
            } else if (match[2].length === 3) {
              return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString.replace('w', '.'), 'YYYY.WW').toDate(); // unfortunately 'w' is a token in moment
            } else if (match[1]) {
              return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString, 'YYYY').toDate();
            }
          }
        }
      },
      ...
      week: function week(timeString) {
        return moment__WEBPACK_IMPORTED_MODULE_1___default.a.utc(timeString.replace('w', '.'), 'YYYY.WW').toDate();
      },
      // unfortunately 'w' is a token in moment
